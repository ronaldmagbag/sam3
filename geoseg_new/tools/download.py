...
from tiles import tiles_from_csv, fetch_image


def add_parser(subparser):
    parser = subparser.add_parser(
        "download", help="downloads images from tile server", formatter_class=argparse.ArgumentDefaultsHelpFormatter
    )
...
def main(args):
    ...
    with requests.Session() as session:
        ...
        with tqdm(total=len(tiles), ascii=True, unit="image") as progress:
